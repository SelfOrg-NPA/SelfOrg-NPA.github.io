!function (t, e) {
    ...
    return function (i) {
        ...
        var n = i(2), s = function (e, t) {
            ...
            var e = 1 < arguments.length && void 0 !== arguments[1] && arguments[1], i = t.offsetHeight;
            if (e) {
        ...
        var s = function () {
            ...
            return n(s, [{
                ...
                key: "distance", value: function (t) {
                    var e = this._x - t._x, i = this._y - t._y;
                ...
                key: "constrain", value: function (t, e) {
                    if (t._x > e._x || t._y > e._y) return this;
                    var i = this._x, n = this._y;
                ...
                key: "reposition", value: function (t) {
        ...
        var n = i(6), s = i(0), a = i(2), r = i(3), l = i(7), h = i(9), u = i(10), d = i(11), c = i(13), f = i(15),
            p = i(18), v = i(19), y = i(22), _ = i(23), g = i(24), b = Object.assign || function (t) {
        ...
        var o = function (t) {
            ...
            return function (t, e) {
                ...
                key: "_createSlide", value: function (t, e) {
                ...
                key: "_setClasses", value: function () {
                    var e = this;
                ...
                key: "index", set: function (t) {
                    this._index = t
                }, get: function () {
                    return this._index
                }
            }, {
                key: "length", set: function (t) {
                    this._length = t
                }, get: function () {
                    return this._length
                }
                ...
                key: "slideWidth", get: function () {
                    return this._slideWidth || 0
                }
            }, {
                key: "transitioner", get: function () {
                    return this._transitioner
                }
            }], [{
                key: "attach", value: function () {
                    var i = this, t = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : ".slider",
                        n = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : {}, s = new Array,
        ...
        var o = function (t) {
            ...
            return function (t, e) {
                ...
                key: "onVisibilityChange", value: function (t) {
        ...
        var n = !!("ontouchstart" in window), s = !!("PointerEvent" in window),
            r = n || window.DocumentTouch && document instanceof DocumentTouch || navigator.maxTouchPoints,
            o = r && s ? "pointerenter" : "mouseenter", a = r && s ? "pointerleave" : "mouseleave"
    }, function (t, e, i) {
        "use strict";
        var n = function () {
            function n(t, e) {
        ...
        var s = Symbol("onResize"), r = function () {
            function e(t) {
                !function (t, e) {
                    if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function")
            ...
            return n(e, [{
                ...
                key: "_getActiveBreakpoint", value: function () {
                ...
                key: "getSlidesToShow", value: function () {
                    return this._currentBreakpoint ? this._currentBreakpoint.slidesToShow : this._defaultBreakpoint.slidesToShow
                }
            }, {
                key: "getSlidesToScroll", value: function () {
        ...
        var s = function () {
            ...
            return n(e, [{
                ...
                key: "onTransitionEnd", value: function (t) {
                ...
                key: "_cloneSlide", value: function (t, e) {
                    var i = t.cloneNode(!0);
        ...
        "use strict";
        var n = i(16), s = i(17), r = i(1), o = function () {
            function n(t, e) {
                for (var i = 0; i < e.length; i++) {
                    var n = e[i];
                    n.enumerable = n.enumerable || !1, n.configurable = !0, "value" in n && (n.writable = !0), Object.defineProperty(t, n.key, n)
        ...
        var a = function () {
            ...
            return o(e, [{
                key: "init", value: function () {
                    return this._pages = [], this.node = document.createRange().createContextualFragment(Object(n.a)()), this._ui = {container: this.node.firstChild}, this._count = Math.ceil((this.slider.state.length - this.slider.slidesToShow) / this.slider.slidesToScroll), this._draw(), this.refresh(), this
                }
            }, {
                key: "destroy", value: function () {
                    this._unbindEvents()
                ...
                key: "onPageClick", value: function (t) {
        ...
        var o = function () {
            ...
            return r(e, [{
                ...
                key: "onStartDrag", value: function (t) {
                    if (t.touches) {
                ...
                key: "onMoveDrag", value: function (t) {
                    if (this._origin) {
                ...
                key: "onStopDrag", value: function (t) {
        ...
        "use strict";
        var s = i(0), r = Object.assign || function (t) {
            for (var e = 1; e < arguments.length; e++) {
                var i = arguments[e];
                for (var n in i) Object.prototype.hasOwnProperty.call(i, n) && (t[n] = i[n])
            }
            ...
            return o(n, [{
                ...
                key: "apply", value: function (t) {
                    ...
                    this._oldSlide = this.slider.slides.filter(function (t) {
                        ...
                        return t.dataset.sliderIndex == e.slider.state.next
                    })[0], this._oldSlide && this._newSlide && (Object(s.a)(this._oldSlide, {opacity: 0}), Object(s.a)(this._newSlide, {
                        opacity: 1,
                        "z-index": t ? 0 : -1
                    }))
                }
                ...
                key: "onTransitionEnd", value: function (t) {
                    "fade" === this.options.effect && (this.transitioner.isAnimating() && t.target == this._newSlide && (this._newSlide && (Object(s.a)(this._newSlide, {"z-index": 0}), this._newSlide.removeEventListener("transitionend", this.onTransitionEnd.bind(this))), this._oldSlide && (Object(s.a)(this._oldSlide, {"z-index": -2}), this._oldSlide.removeEventListener("transitionend", this.onTransitionEnd.bind(this)))), this.transitioner.end())
                }
            }]), n
        }();
        e.a = n
        ...
        "use strict";
        var r = i(4), o = i(0), s = Object.assign || function (t) {
            for (var e = 1; e < arguments.length; e++) {
                var i = arguments[e];
                for (var n in i) Object.prototype.hasOwnProperty.call(i, n) && (t[n] = i[n])
            }
                ...
                key: "apply", value: function () {
                    ...
                    if ("translate" === this.options.effect) {
                        var i = this.slider.slides.filter(function (t) {
                            return t.dataset.sliderIndex == e.slider.state.next
                        })[0], n = new r.a(i.offsetLeft, i.offsetTop);
