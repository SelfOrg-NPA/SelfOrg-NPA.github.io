    ...
    function step_fast() {
        ...
        glsl({
            ...
            void fragment() {
                ...
                FOut = state_i[0]; FOut1 = state_i[1]; FOut2 = state_i[2]; FOut3 = state_i[3]; FOut4 = Src(I,C4); FOut5 = Src(I,C4+1);
                ...
                vec2 p_new = hi.xy + lo.xy + dt * alpha * eps * dx / (1.0 + length(dx));
                FOut4 = pack_pos_hi(p_new, hi.z, hi.w);
